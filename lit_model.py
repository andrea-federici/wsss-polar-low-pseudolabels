...
class LitModel(LightningModule):
    ...
    def process_epoch_end(self, stage: str):
        ...
        self.log('{stage}/epoch_loss', avg_loss)
        self.log('{stage}/epoch_accuracy', accuracy)
        self.log('{stage}/epoch_precision', precision)
        self.log('{stage}/epoch_recall', recall)
        self.log('{stage}/epoch_f1', f1)
